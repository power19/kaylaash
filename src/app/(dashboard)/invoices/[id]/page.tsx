        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span>$1 = {formatSrd(invoice.exchangeRate)}</span>
            </div>
          </CardContent>
        </Card>
            ...
            <TableBody>
              {invoice.items.map((item) => {
                ...
                return (
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="text-right">
                      {formatSrd(
                        convertUsdToSrd(item.unitPriceUsd, invoice.exchangeRate)
                      )}
                    </TableCell>
                    ...
                    <TableCell className="text-right font-medium">
                      {formatSrd(convertUsdToSrd(totalUsd, invoice.exchangeRate))}
                    </TableCell>
                  </TableRow>
                );
              })}
              <TableRow>
                ...
                <TableCell className="text-right font-bold text-blue-600">
                  {formatSrd(
                    convertUsdToSrd(invoice.totalUsd, invoice.exchangeRate)
                  )}
                </TableCell>
              </TableRow>
            </TableBody>
